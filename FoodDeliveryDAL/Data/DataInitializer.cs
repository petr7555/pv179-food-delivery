...
public static class DataInitializer
{
    public static void Seed(this ModelBuilder modelBuilder)
    {
        ...
        var customer = new User { Id = 3, Username = "customer", Password = "customer", Salt = "3", RoleId = 3, CustomerDetailsId = 3 };
        ...
        var softDrinksCategory = new Category { Id = 15, Name = "Soft Drinks", ParentCategoryId = nonAlcoholicCategory.Id };
